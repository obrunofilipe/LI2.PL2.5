...
void {\bfseries grava\+\_\+dados} (\hyperlink{structESTADO}{E\+S\+T\+A\+DO} $\ast$e, char $\ast$file\+\_\+name)
\item 
...
void {\bfseries ler\+\_\+dados} (\hyperlink{structESTADO}{E\+S\+T\+A\+DO} $\ast$e, char $\ast$file\+\_\+name)
\end{DoxyCompactItemize}
...
{\em e} & Apontador para o estado atual \\
\hline
{\em num\+Jogadas} & O número de jogads atuais \\
\hline
\end{DoxyParams}
